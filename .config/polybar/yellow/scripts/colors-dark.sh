...
# Color files
PFILE="$HOME/.config/polybar/yellow/colors.ini"
RFILE="$HOME/.config/polybar/yellow/scripts/rofi/colors.rasi"
...
if  [[ $1 = "--amber" ]]; then
	...
	--cyan	--deep-orange	--deep-purple	--yellow
	--gray	--indigo	--light-blue	--light-yellow
